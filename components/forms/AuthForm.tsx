        ...
        <Form {...form}>
            <form className={"mt-10 space-y-6"} onSubmit={form.handleSubmit(onSubmit)}>
                                ...
                                <FormItem className="flex w-full flex-col gap-2.5">
                                    ...
                                    <FormControl>
                                        <Input
                                            ...
                                            required type={field.name === "password" ? "password" : "text"} {...field} />
                                    </FormControl>
                ...
                {formType === "SIGN_IN" ? <
                    ...
                    <p> Already having an account <Link className="paragraph-semibold primary-text-gradient" href={ROUTES.SIGN_IN}>Sign in </Link></p>
                }
            </form>
        </Form>
    )
